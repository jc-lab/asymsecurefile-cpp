        ...
        namespace signedsecurefile {
            namespace exception {
                ...
                public:
                    ...
                    InvalidFileException(const char *message) : SignedSecureFileException("InvalidFileException",
                                                                                          message) {
                    }

                    InvalidFileException(const char *message, int code) : SignedSecureFileException(
                            "InvalidFileException", message, code) {
                    }
                };
