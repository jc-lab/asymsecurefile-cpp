...
namespace asymsecurefile {
    namespace internal {
        namespace signedsecurefile {
            ...
            InputStream::InputStream(jcp::AsymKey *pubKey, const std::string &secretKey) : header(this) {
            ...
            int InputStream::input(const unsigned char *payload, size_t size,
                                   exception::SignedSecureFileException *exception) {
                jcp::AsymKey *key = this->header.getAsymKey();
                int rc;
