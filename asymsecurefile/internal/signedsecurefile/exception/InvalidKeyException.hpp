        ...
        namespace signedsecurefile {
            namespace exception {
                ...
                public:
                    ...
                    InvalidKeyException(const char *message) : SignedSecureFileException("InvalidKeyException",
                                                                                         message) {
                    }

                    InvalidKeyException(const char *message, int code) : SignedSecureFileException(
                            "InvalidKeyException", message, code) {
                    }
                };
